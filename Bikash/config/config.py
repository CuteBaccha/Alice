...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", " Alice")
OWNER_ID = list(map(int, getenv("OWNER_ID", "").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY")
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME")
UPSTREAM_REPO = getenv("UPSTREAM_REPO","https://github.com/CuteBaccha/Alice",)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "Alice")
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://t.me/Alice")
...
# All Images Of Bikash Aditya Player //  @I_LOVE_YOU_MY_HEARTBEET @ID_SELLER00
START_IMG_URL = getenv("START_IMG_URL", f"https://telegra.ph/file/5081730e52145378eb3b8.jpg")
